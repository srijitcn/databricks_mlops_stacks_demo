...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_stacks_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/mlops_stacks_demo/mlops_stacks_demo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/mlops_stacks_demo/mlops_stacks_demo-model)
. 

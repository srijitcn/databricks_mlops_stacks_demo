...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops_stacks_demo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops_stacks_demo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops_stacks_demo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.cicd_proj.mlops_stacks_demo-model", "Full (Three-Level) Model Name")
...
# from databricks.feature_engineering import FeatureEngineeringClient ## did we miss this in the FE updates?
## doesn't seem to work... 
# def get_fs_model(df):
#     fe_client = FeatureEngineeringClient()
#     return (
#         fe_client.score_batch({
#             "model_uri": model_uri,
